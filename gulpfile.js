...
var scssFilesPath = 'main/assets/scss/**/*.scss'; // scss files to watch
...
gulp.task('scripts', function () {
  return gulp.src([utilJsPath + '/util.js', componentsJsPath], {allowEmpty: true})
...
gulp.task('watch', gulp.series(['browserSync', 'sass', 'scripts'], function () {
  ...
  gulp.watch('main/assets/scss/**/*.scss', gulp.series(['sass']));
